...
![此处输入图片的描述](img/git/clip_image006.png)

点击上图绿色按钮，跳转到下图：

![此处输入图片的描述](img/git/clip_image007.png)
...
![](img/git/clip_image043.png)

创建文件，添加到暂存区，提交，查看本地仓库分支状态：

![](img/git/clip_image044.png)

![](img/git/clip_image045.png)
